...
export default function UserAccount() {
  ...
  return (
    <div className="w-[55%] m-auto h-[80vh] text-WHITE rounded-lg justify-center">
      <div className="bg-WHITE py-2 justify-center">
        <h1 className="justify-center text-center w-[50%] m-auto rounded font-serif text-2xl bg-BACKGROUND">
          {" "}
          User: {userName || "N/a"} Order History:
        </h1>
